...
function Footer() {
	return (
		<div>
			<footer
				className=" bg-[url('/src/assets/images/glidePath-heroPage.jpg')]  text-[#292D32] py-[90px] px-[120px] font-Montserrat lg:block hidden"
				id="contact us"
			>
					...
					<div className="flex gap-[150px]">
						...
						<div>
							...
							<p className="text-[14px] leading-relaxed">
								HEAD OFFICE: <br />
								31 GB Samfra plaza Ndola Crescent <br /> Ndola crescent <br />
								opposite grand Idu orphanage <br /> Wuse Zone 5 Abuja <br />
							</p>
						...
						{/* Instagram Section */}
						<div>
							<h3 className="font-semibold mb-5 text-[20px]">On Instagram</h3>
			...
			<section className="lg:hidden text-[#ffffff] font-Montserrat">
				<footer className="relative py-10 px-[16px]   bg-[url('/src/assets/images/contactbgm.jpg')] font-Montserrat">
					<div className="    ">
						<div className="  ">
					...
					<div className="">
						<div className="flex justify-between py-9">
							...
							<div>
								...
								<p className="text-[14px] leading-relaxed">
									HEAD OFFICE: <br />
									31 GB Samfra plaza Ndola <br /> Crescent Ndola crescent <br />
									opposite grand Idu <br /> orphanage Wuse Zone 5 Abuja <br />
								</p>
								<div className="mt-3 text-[14px]">
									<p> +234 (0) 707 421 3046</p>
									<p>+234 (0) 707 421 3047</p>
