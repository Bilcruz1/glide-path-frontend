...
function Hamburger({ setIsOpen }) {
	...
	return (
		<div className="fixed top-0 left-0 w-[calc(100%-32px)] font-satoshi ml-[16px] mx-[32px]    z-[10]">
			<div
			...
			>
				<div className="bg-[#222222]  rounded-md   w-full pt-[70px]   flex flex-col px-[24px]  gap-[40px] pb-[24px]">
